...
export const productionOrders: ProductionOrder[] = [
  ...
  {
    id: 'order-2026-006', orderNumber: mockOrderNumber(6), product: product('F3208'), items: [{ color: 'Beige', quantity: 900 }], totalQuantity: 900,
    deliveryBatches: [singleColorBatch('batch-006-1', 1, 'Beige', 900, 900, '2026-09-18', 'Australia')], status: 'completed', createdAt: '2026-08-28',
  },
  {
    id: 'order-2026-007', orderNumber: mockOrderNumber(7), product: product('A2387'), items: [{ color: 'White', quantity: 2600 }], totalQuantity: 2600,
  ...
  {
    id: 'order-2026-010', orderNumber: mockOrderNumber(10), product: product('C5510'), items: [{ color: 'Navy', quantity: 1600 }], totalQuantity: 1600,
